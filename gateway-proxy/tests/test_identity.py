...
def test_apply_updates_state_and_reports_change():
    identity.state.update(
        {"user_agent": "fx/0.0.4", "protocol_version": "0.0.1", "specification_version": "4"}
    )
    changed = apply("fx/0.0.5", ("0.0.2", "5"))
...
def test_apply_is_idempotent():
    first = apply("fx/0.0.5", ("0.0.2", "5"))
    second = apply("fx/0.0.5", ("0.0.2", "5"))
